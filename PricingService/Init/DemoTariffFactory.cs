...
namespace PricingService.Init
{
    ...
    internal static class DemoTariffFactory
    {
        ...
        internal static Tariff Farm()
        {
            ...
            farm.BasePremiumRules.AddBasePriceRule("C1", null, "10B");
            farm.BasePremiumRules.AddBasePriceRule("C2", null, "20B");
            farm.BasePremiumRules.AddBasePriceRule("C3", null, "30B");
            farm.BasePremiumRules.AddBasePriceRule("C4", null, "40B");
        ...
        internal static Tariff Car()
        {
            ...
            car.BasePremiumRules.AddBasePriceRule("C1", null, "100B");
